  ...
  public: {
    Tables: {
      avaliacoes_iphone: {
        ...
        Relationships: [
          {
            foreignKeyName: "avaliacoes_iphone_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
      ...
      config_checklist_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "config_checklist_categories_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
      ...
      config_checklist_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "config_checklist_items_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "config_checklist_categories"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "config_checklist_items_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
      ...
      config_descontos_perifericos: {
        ...
        Relationships: [
          {
            foreignKeyName: "config_descontos_perifericos_checklist_item_id_fkey"
            columns: ["checklist_item_id"]
            isOneToOne: false
            referencedRelation: "config_checklist_items"
            referencedColumns: ["id"]
          },
          {
          ...
          {
            foreignKeyName: "config_descontos_perifericos_modelo_id_fkey"
            columns: ["modelo_id"]
            isOneToOne: false
            referencedRelation: "config_precos_base"
            referencedColumns: ["id"]
          },
        ]
      }
